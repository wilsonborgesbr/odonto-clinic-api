...
@Tag(name = "Funcionario", description = "Endpoints para gerenciamento de funcionários da clínica")
public class FuncionarioController {
    ...
    @GetMapping
    public ResponseEntity<Page<FuncionarioListagemDTO>> listarTodos(
            @PageableDefault(size = 10, sort = "nomeCompleto") Pageable pageable) {
        Page<FuncionarioListagemDTO> funcionarios = funcionarioService.listarTodos(pageable);
